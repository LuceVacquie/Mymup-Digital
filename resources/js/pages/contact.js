                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-24">
                    <div>
                        <div className="mb-14">
                            ...
                            <h2 className="text-4xl font-extrabold text-darkGrey tracking-tight sm:text-4xl">Get in touch</h2>
                            ...
                            If you have any questions or queries regarding MYMUP Digital then please give us a call or email on the details below.
                            </p>
                        </div>

                        <div className="flex border border-lightGrey p-12 mb-7 text-lg" style={{height: 'fit-content'}}>
                        ...
                        <div className="flex items-center border border-lightGrey p-12 text-lg" style={{height: 'fit-content'}}>
                            <div className="text-blue">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="text-blue hover:text-darkBlue ml-8">
                                <p><a href="mailto:info@mymup.org">info@mymup.org</a></p>
                                <p><a href="tel:01274 897714">01274 897714</a></p>
                            </div>
                        </div>
                    </div>
